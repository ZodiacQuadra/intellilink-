...
const Component = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  ...
  return /*#__PURE__*/ _jsx(SVG, {
    ...restProps,
    className: cx("framer-30Bgq", className),
    layoutId: layoutId,
    ref: ref,
    role: "presentation",
    style: {
 ...
 * @framerVector {"name":"Check Circle","color":{"type":"variable","value":"21h8s6"},"set":{"localId":"vectorSet/NGVKdicsm","id":"NGVKdicsm","moduleId":"omX0gWFPqDwhaiWwf6ab"}}
 * @framerDisableUnlink true
 */ const Icon = withCSS(Component, css, "framer-30Bgq");
...
export const __FramerMetadata__ = {
  exports: {
    default: {
      ...
      annotations: {
        framerVector:
          '{"name":"Check Circle","color":{"type":"variable","value":"21h8s6"},"set":{"localId":"vectorSet/NGVKdicsm","id":"NGVKdicsm","moduleId":"omX0gWFPqDwhaiWwf6ab"}}',
        framerSupportedLayoutWidth: "any-prefer-fixed",
        framerVariables:
